...
+ (NSString*)stringWithArray:(NSArray*)array omit:(NSString*)omit {
	NSCharacterSet* leftTight = [NSCharacterSet characterSetWithCharactersInString: [NSString stringWithUTF8String: "([{\'\"<„"]];
	NSCharacterSet* rightTight = [NSCharacterSet characterSetWithCharactersInString: [NSString stringWithUTF8String: ",.;:)]}\'\">“!?"]];
...
- (NSArray*)tokenize {
	NSCharacterSet* marginalCharacters = [NSCharacterSet characterSetWithCharactersInString: [NSString stringWithUTF8String: ",.;:()[]{}\'\"<>„“!?"]];
	NSCharacterSet* internalCharacters = [NSCharacterSet characterSetWithCharactersInString: [NSString stringWithUTF8String: "-/+*.,\\\'"]];
	NSCharacterSet* colonCharacter = [NSCharacterSet characterSetWithCharactersInString: [NSString stringWithUTF8String: ":"]];
